...
export function createVirginiaOntology() {
  ...
  ontology.defineObjectType({
    ...
    properties: { id: 'string', name: 'string', category: 'string', freshness: 'string' },
  });
  ontology.defineObjectType({
    apiName: 'Observation',
    ...
    description: 'A source-backed observation with explicit provenance and confidence.',
    properties: { id: 'string', summary: 'string', observedAt: 'timestamp', confidence: 'double', sourceId: 'string' },
  });
  ontology.defineObjectType({
    apiName: 'Application',
